...
```{r fig.align="center", echo=FALSE, out.width="100%", fig.cap = "Object Panel Data Nodes"}
knitr::include_graphics("images/screenshots/datanodes.png")
```


```{r fig.align="center", echo=FALSE, out.width="100%", fig.cap = "Molecular and Concept Data Nodes"}
