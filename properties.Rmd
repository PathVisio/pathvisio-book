...
* Also see [meta-information](pathway-meta-info.md)
...
1. Load Identifier Mapping Database, if not done so already, instruction [here](load-identifier-mapping-database.html)
