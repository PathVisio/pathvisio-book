...
![](images/screenshots/data-nodes-theme.png){width=80%}

```{r fig.align="center", echo=FALSE, fig.cap = "default color(text, border, and fill) and shape of data nodes according to WikiPathways Theme"}
knitr::include_graphics("images/screenshots/data-nodes-theme.png")
```
