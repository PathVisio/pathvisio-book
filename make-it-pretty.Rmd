...
```{r fig.align="center", echo=FALSE, fig.cap = "Properties tab when editing a shaped pathway element"}
...
```{r fig.align="center", echo=FALSE, fig.cap = "Properties tab when editing a line pathway element"}
...
```{r fig.align="center", echo=FALSE, fig.cap = "Group types"}
...
![](images/gifs/color-background.gif)
